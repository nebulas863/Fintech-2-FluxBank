...
// Import the functions you need from the SDKs you need
  ...
  import { getFirestore, collection, doc, onSnapshot, addDoc, getDoc, serverTimestamp, updateDoc, runTransaction, query, orderBy, getDocs,where } from "https://www.gstatic.com/firebasejs/12.11.0/firebase-firestore.js";
    ...
    try {
        ...
        await runTransaction(db, async (transaction) => {
            ...
            if (recipientSnapshot.empty) {
                ...
                //     Swal.fire({
                //     title: "Invalid Recipient",
                //     text: "Recipient account number not found.",
                //     icon: "warning"
                // });
            ...
            const recipientData = recipientDoc.data();
             ...
             if (recipientId === sender.uid) {
                ...
                // Swal.fire({
                //     title: "Invalid",
                //     text: "You cannot transfer to yourself.",
                //     icon: "warning"
                // });
